...
export class PromiseAccountApi {
     ...
     * @param v 
     */
    public getSettings(v: number, _options?: Configuration): Promise<any> {
        const result = this.api.getSettings(v, _options);
     ...
     * @param loginBody 
     */
    public login(v: number, loginBody: LoginBody, _options?: Configuration): Promise<LoginResponse> {
        const result = this.api.login(v, loginBody, _options);
        return result.toPromise();
    }
     ...
     * @param v 
     */
    public logout(v: number, _options?: Configuration): Promise<void> {
        const result = this.api.logout(v, _options);
        return result.toPromise();
    }
     ...
     * @param v 
     */
    public verifyKey(v: number, _options?: Configuration): Promise<VerifyKeyResponse> {
        const result = this.api.verifyKey(v, _options);
        return result.toPromise();
    }
...
export class PromiseJobApi {
     ...
     * @param isDuplicate 
     */
    public addMediaFile(v: number, jobId: string, contentLength: number, body: HttpFile, isDuplicate?: 'true' | 'false', _options?: Configuration): Promise<AddMediaResponse> {
        const result = this.api.addMediaFile(v, jobId, contentLength, body, isDuplicate, _options);
        return result.toPromise();
    }
     ...
     * @param isDuplicate 
     */
    public addMediaUrl(v: number, jobId: string, mediaUrl: string, isDuplicate?: 'true' | 'false', _options?: Configuration): Promise<AddMediaResponse> {
        const result = this.api.addMediaUrl(v, jobId, mediaUrl, isDuplicate, _options);
        return result.toPromise();
    }
     ...
     * @param jobId 
     */
    public authorizeJob(v: number, jobId: string, _options?: Configuration): Promise<void> {
        const result = this.api.authorizeJob(v, jobId, _options);
        return result.toPromise();
    }
     ...
     * @param jobId 
     */
    public jobInfo(v: number, jobId: string, _options?: Configuration): Promise<JobInfoResponse> {
        const result = this.api.jobInfo(v, jobId, _options);
        return result.toPromise();
    }
     ...
     * @param newJobBody 
     */
    public newJob(v: number, newJobBody: NewJobBody, _options?: Configuration): Promise<NewJobResponse> {
        const result = this.api.newJob(v, newJobBody, _options);
        return result.toPromise();
    }
     ...
     */
    public performTranscription(v: number, performTranscriptionBody: PerformTranscriptionBody, _options?: Configuration): Promise<PerformTranscriptionResponse> {
        const result = this.api.performTranscription(v, performTranscriptionBody, _options);
        return result.toPromise();
    }
     ...
     */
    public performTranslation(v: number, jobId: string, targetLanguages: string, approveUplevel?: 'true' | 'false' | 't' | 'f' | 'true' | 'false', _options?: Configuration): Promise<PerformTranslationResponse> {
        const result = this.api.performTranslation(v, jobId, targetLanguages, approveUplevel, _options);
        return result.toPromise();
    }
